...
slicing_name=str_name[:str_name.index('|')] #index Is print starting (|)
...
slicing_price =str_name[str_name.index('|')+1:str_name.rindex ('|')] #index Is print  staring (| ) ,rindex Is print Last (|)
print (slicing_price)
